...
#pragma unused (target, flags)
	...
	NSCAssert([(__bridge NSObject*) info isKindOfClass: [AliyunPVReachability class]], @"info was wrong class in ReachabilityCallback");

    AliyunPVReachability* noteObject = (__bridge AliyunPVReachability *)info;
...
@implementation AliyunPVReachability {
	SCNetworkReachabilityRef _reachabilityRef;
}

+ (instancetype)reachabilityWithHostName:(NSString *)hostName {
	AliyunPVReachability* returnValue = NULL;
...
- (AliyunPVNetworkStatus)networkStatusForFlags:(SCNetworkReachabilityFlags)flags {
	...
	if ((flags & kSCNetworkReachabilityFlagsReachable) == 0) {
		...
		return AliyunPVNetworkNotReachable;
	}

    AliyunPVNetworkStatus returnValue = AliyunPVNetworkNotReachable;

	if ((flags & kSCNetworkReachabilityFlagsConnectionRequired) == 0) {
		/*
         If the target host is reachable and no connection is required then we'll assume (for now) that you're on Wi-Fi...
         */
		returnValue = AliyunPVNetworkReachableViaWiFi;
	}
	...
	if ((flags & kSCNetworkReachabilityFlagsIsWWAN) == kSCNetworkReachabilityFlagsIsWWAN) {
         ...
         */
		returnValue = AliyunPVNetworkReachableViaWWAN;
	}
